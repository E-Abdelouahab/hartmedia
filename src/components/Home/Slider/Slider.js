                        ...
                        <div className="row slide-part">
                            <div className="col-md-6 col-sm-12">
                                <div className="slide-des" style={{ textAlign: 'left', margin: 'auto', paddingLeft: '10%' }}>
                                    <h4 className="text-white" style={{ fontWeight: '400' }}>MANAGE IT, Full Stack Developer</h4>
                                    <h1 className="text-white">TOP WEB DESIGN & MOBILE</h1>
                                    <h3 className="text-white">HART MEDIA TECHNOLOGY</h3>
                                </div>
                            </div>
