            ...
            <div class="row inner-tools-area" >
                <div className="col-md-2 toolsbar">
                    <ul className="text-left" style={{textAlign:'center'}}>
                        <li><a href="mailto:info@hartmediatech">support@hartmediatech.ma</a></li>
                    </ul>
                </div>
                <div className="col-md-8 toolsbar" style={{borderLeft:'1px solid grey', borderRight:'1px solid grey'}}>
                    <ul className="d-flex justify-content-between">
                        <li><i class="fa fa-phone"></i><a href="tel:+123456789">(+212) 6-97-40-51-00</a></li>
                        <li class="opening"> <i class="fa fa-clock-o"></i> Mon - Fri: 9:00 am - 19.00pm / Closed on Weekends</li>
                    </ul>
                </div>
                <div className="col-md-2 toolsbar">
