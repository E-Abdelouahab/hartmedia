...
import './Team.css';
import ceo from '../../../images/team/seo/1.png'
import developer from '../../../images/team/seo/2.png'
import marketer from '../../../images/team/seo/3.png'
            ...
            <div class="" style={{width: '90%', margin: 'auto'}}>
                ...
                <div className=" row d-flex" >
                    ...
                    <div class="col-md-4 team-item-wrap p-5">
                        ...
                        <div class="team-content text-center">
                            <h4 class="person-name"><a href="team-single.html">Abdelouahab Elhassnaoui</a></h4>
                    ...
                    <div class="col-md-4 team-item-wrap p-5">
                        ...
                        <div class="team-content text-center">
                            <h4 class="person-name"><a href="team-single.html">Akram Reqqi</a></h4>
                            <span class="designation">Web & mobile Developer</span>
                            <ul class="team-social">
                                <li><a href="team-single.html"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="team-single.html"><i class="fa fa-instagram"></i></a></li>
                                <li><a href="team-single.html"><i class="fa fa-twitter"></i></a></li>
