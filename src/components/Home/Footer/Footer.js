                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-sm-12 footer-widget md-mb-39">
                            <div class="about-widget pr-15">
                                ...
                                <p class="desc">Heart Media Technology is a young dynamic company with an innovative concept in the field of online file management and planning for flexible workers. Through years of experience, including as a planner in the audiovisual industry, programming, applications, and web design.</p>
                                <div class="btn-part">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 md-mb-32 footer-widget">
                            ...
                            <ul class="address-widget pr-40">
                                <li>
                                    ...
                                    <div class="desc">Lot 660, Ben Guerir 43150, Morocco.</div>
                                </li>
                                <li>
                                    <i class="flaticon-call"></i>
                                    <div class="desc">
                                        <a href="tel:+212697405100">(+212)697405100</a>
                                    </div>
                                </li>
                                <li>
                                    <i class="flaticon-email"></i>
                                    <div class="desc">
                                        <a href="mailto:abdelouahabelhassnaoui36@gmail.com">abdelouahabelhassnaoui36@gmail.com</a>
                                    </div>
                                </li>
                                <li>
                ...
                <div class="footer-bottom">
                    <div class="row y-middle">
                        <div class="col-lg-6 col-md-8 sm-mb-21">
                            <div class="copyright">
                                <p>© Copyright 2021 Hart Media Technology. All Rights Reserved.</p>
                            </div>
                        </div>
