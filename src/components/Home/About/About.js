                            ...
                            <div id="accordion" class="accordion">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" data-parent="#accordion">
                                        <div class="card-body">Creating pixel-perfect layouts is very important for web developers since most websites have a mockup behind them. With layout models and semantic HTML, we can create almost any website with high fidelity while taking care of accessibility and responsiveness.</div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header">
                                    ...
                                    <div id="collapseTwo" class="collapse" data-parent="#accordion">
                                        <div class="card-body">The free version already comes with plenty of templates and features. Layouts can be set flexibly and precisely. Fast, fluid editing mode including real-time front-end editing. Many high-quality elements that can be quickly adjusted and used.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
